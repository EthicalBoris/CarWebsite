...
<html>
  ...
  <div class="content">
    <img src="Images/mondeo.png">
    
		<form class="configuration" action="confirm.php" method="get">
    <div class = "hiddens">  
        <input type="radio" name = "car" value = "mondeo" checked="checked">
        <input type="radio" name = "car" value = "focus" >
        <input type="radio" name = "car" value = "fiesta">
    </div>
      <section class = "carTrim config">  
        
        <h1>Choose a Trim:</h1>

        <?php        
        $query = "SELECT * FROM trims WHERE carID=1 ORDER BY price";
      ...
      <h1>Choose a colour:</h1>
        <?php
          $query = "SELECT*From colours WHERE carID=1 ORDER BY price";
          $result = mysqli_query($conn,$query);        
      ...
      <h1>Interior</h1>
      <?php
          $query = "SELECT*From interiors WHERE carID=1 ORDER BY price";
          $result = mysqli_query($conn,$query);        
    ...
    <?php
          $query = "SELECT*From engines WHERE carID=1 ORDER BY price";
          $result = mysqli_query($conn,$query);        
    ...
    <?php
          $query = "SELECT*From wheels WHERE carID=1 ORDER BY price";
          $result = mysqli_query($conn,$query);        
    ...
    <?php
          $query = "SELECT*From sensors WHERE carID=1 ORDER BY price";
          $result = mysqli_query($conn,$query);        
