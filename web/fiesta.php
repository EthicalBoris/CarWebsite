...
<html>
  ...
  <div class="content">
    ...
    <div class = "hiddens">  
        ...
        <input type="radio" name = "car" value = "fiesta" checked="checked">
    </div>
      ...
      <section class = "trim config">    
        ...
        <?php        
        $query = "SELECT * FROM trims WHERE carID=3 ORDER BY price";
      ...
      <h1>Choose a colour:</h1>
        <?php
          $query = "SELECT*From colours WHERE carID=3 ORDER BY price";
          $result = mysqli_query($conn,$query);        
      ...
      <h1>Interior</h1>
      <?php
          $query = "SELECT*From interiors WHERE carID=3 ORDER BY price";
          $result = mysqli_query($conn,$query);        
    ...
    <?php
          $query = "SELECT*From engines WHERE carID=3 ORDER BY price";
          $result = mysqli_query($conn,$query);        
    ...
    <?php
          $query = "SELECT*From wheels WHERE carID=3 ORDER BY price";
          $result = mysqli_query($conn,$query);        
    ...
    <?php
          $query = "SELECT*From sensors WHERE carID=3 ORDER BY price";
          $result = mysqli_query($conn,$query);        
